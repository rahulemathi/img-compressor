            ...
            <div class="rounded-2xl bg-white">
                <div class="px-6 py-8 sm:px-10">
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="hidden sm:inline-flex items-center gap-2 rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white hover:bg-gray-800">
                    ...
                    <form id="compress-form" action="<?php echo e(route('compressor.compress')); ?>" method="POST" enctype="multipart/form-data" class="mt-6">
                        ...
                        <div class="mt-6 grid gap-4 sm:grid-cols-3 sm:items-center">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-500 hover:text-gray-700 sm:hidden">Login for API key →</a>
                        </div>
                    </form>
                </div>
            </div>
