    ...
    <header class="border-b bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <nav class="mx-auto flex max-w-3xl items-center justify-between px-6 py-3 sm:px-10" aria-label="Global">
            ...
            <div class="hidden items-center gap-3 sm:flex">
                <a href="{{ url('/compressor') }}" class="text-sm text-gray-600 hover:text-gray-900">Compressor</a>
                @auth
                    <a href="{{ url('/dashboard') }}" class="text-sm text-gray-600 hover:text-gray-900">Dashboard</a>
                @endauth
                @guest
                    <a href="{{ route('login') }}" class="inline-flex items-center rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white hover:bg-gray-800">Login</a>
        ...
        <div id="mobile-menu" class="mx-auto hidden max-w-3xl px-6 pb-3 sm:px-10">
            <div class="flex flex-col gap-2 rounded-lg border border-gray-200 bg-white p-3">
                <a href="{{ url('/compressor') }}" class="text-sm text-gray-700">Compressor</a>
                @auth
